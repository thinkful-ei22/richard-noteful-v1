...
-- select id, title from noteful order by id;

-- update noteful set title = 'Richard owns a dog' where id = 1003 returning id, title;

-- insert into noteful (title, content) values ('filler', 'filler') returning id, title;

-- delete from noteful where id = 1010;